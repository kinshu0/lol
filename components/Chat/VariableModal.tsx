...
export const VariableModal: FC<Props> = ({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="dark:border-netural-400 inline-block max-h-[400px] transform overflow-y-auto rounded-lg border border-gray-300 bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all dark:bg-[#121212] sm:my-8 sm:max-h-[600px] sm:w-full sm:max-w-lg sm:p-6 sm:align-middle"
        role="dialog"
      >
        ...
        {updatedVariables.map((variable, index) => (
          <div className="mb-4" key={index}>
            ...
            <textarea
              ...
              className="mt-1 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 dark:bg-[#2e3842] dark:text-neutral-100"
              style={{ resize: 'none' }}
