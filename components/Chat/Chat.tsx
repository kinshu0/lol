  ...
  const handleSend = useCallback(
    async (message: Message, deleteCount = 0, plugin: Plugin | null = null) => {
      if (selectedConversation) {
        ...
        // Assuming the server responds with JSON that looks like { message: "hello world" }
        const data = await response.json(); // parse the response body to JSON

        // Check if the response has the expected field (e.g., "message")
        ...
        // Update the conversation in your state, save the conversation, etc.
        homeDispatch({
          field: 'selectedConversation',
          value: updatedConversation,
        });
      ...
      {!(apiKey || serverSideApiKeyIsSet) ? (
        <div className="mx-auto flex h-full w-[300px] flex-col justify-center space-y-6 sm:w-[600px]">
          ...
          <div className="text-center text-lg text-black dark:text-white">
            <div className="mb-8">{`ChatSGPT is an open source clone of OpenAI's ChatGPT UI.`}</div>
            <div className="mb-2 font-bold">
              Important: ChatSGPT is 100% unaffiliated with OpenAI.
            </div>
          </div>
          <div className="text-center text-gray-500 dark:text-gray-400">
            <div className="mb-2">
              ChatSGPT allows you to plug in your API key to use this UI with
              their API.
            </div>
            <div className="mb-2">
